...
- **@kalphq/sdk** - Official SDK for building Kalp agents
- **@kalphq/core** - Runtime core for agent execution
- **@kalphq/compiler** - Code compilation and optimization

## Deployment

- **@kalphq/cli** - Zero-config CLI for deploying Kalp agents
- **@kalphq/cloudflare** - Cloudflare Workers adapter
- **@kalphq/studio** - Admin panel UI

## Tools

- **@kalphq/project** - Scaffolding and template utilities
- **@kalphq/create-kalp** - Bootstrap new projects
