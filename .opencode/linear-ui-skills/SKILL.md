...
- MUST use `Geist` as primary font family
...
| ---------------- | ----- | ---- | ------ | ------- | ----- |
| `heading-1`      | Geist | 60px | 700    | #E2E4E3 | 1     |
| `body`           | Geist | 17px | 400    | #444749 | 1     |
| `body-secondary` | Geist | 16px | 400    | #5C5C5C | 1     |
| `body-secondary` | Geist | 15px | 500    | #2D2E30 | 1     |
| `text-14px`      | Geist | 14px | 400    | #B2B3B3 | 1     |
| `text-13px`      | Geist | 13px | 400    | #4C4C4C | 1     |
| `text-13px`      | Geist | 13px | 400    | #525355 | 1     |
| `text-12px`      | Geist | 12px | 400    | #525456 | 1     |
| `caption`        | Geist | 9px  | 400    | #545557 | 1     |
| `label`          | Geist | 9px  | 400    | #565759 | 1     |
